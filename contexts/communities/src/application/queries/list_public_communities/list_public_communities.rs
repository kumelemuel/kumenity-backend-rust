use crate::application::{
    ports::{
        inbound::list_public_communities_use_case::ListPublicCommunitiesUseCase,
        outbound::community_repository::CommunityRepositoryPort,
    },
    queries::list_public_communities::{
        query::ListPublicCommunitiesQuery,
        response::{CommunityResult, ListPublicCommunitiesResponse},
    },
};
...
impl ListPublicCommunitiesUseCase for ListPublicCommunities {
    fn execute(
        &self,
        ...
        Ok(ListPublicCommunitiesResponse { communities })
    }
}
