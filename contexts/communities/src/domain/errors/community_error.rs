    ...
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            CommunityError::InvalidState => {
                write!(f, "This action is not allowed in the current containers")
            }
        }
    }
}
...
impl ErrorLayout for CommunityError {
    ...
    fn message(&self) -> &'static str {
        match self {
            ...
            CommunityError::InvalidState => "This action is not allowed in the current containers.",
        }
    }
}
